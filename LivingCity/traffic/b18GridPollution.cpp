...
void B18GridPollution::initPollution(LCUrbanMain *_clientMain) {
...
void B18GridPollution::saveToFile(QString fileName) {
  ...
  printf("<<B18GridPollution::saveToFile\n");
}//

void B18GridPollution::loadSimSave(QString fileName, LCUrbanMain *_clientMain) {
  clientMain = _clientMain;
  printf(">>B18GridPollution::loadSimSave\n");
